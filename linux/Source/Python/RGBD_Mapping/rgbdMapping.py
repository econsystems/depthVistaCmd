...
class MainClass:
    ...
    def listDevices(self):
        ...
        self.No_of_devices, self.device_name, self.vid, self.pid, self.device_path, self.serialNo = numberOfDevices, deviceNameValue[choice-1], vidValue[choice-1], pidValue[choice-1], devicePathValue[choice-1], serialNoValue[choice-1]
    ...
    '''
    def Preview(self):
        global rgb_intrinsic, rgbHD_intrinsic, rgbdMappingflag
        while True:
